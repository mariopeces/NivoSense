...
export default function Legend({ layer }: Props) {
  ...
  return (
    <div className="pointer-events-auto absolute bottom-4 right-4 z-20 w-[240px] rounded-xl border border-white/5 bg-slate-950/80 px-4 py-3 backdrop-blur-xl shadow-[0_20px_40px_-12px_rgba(0,0,0,0.7)]">
